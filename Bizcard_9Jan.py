...
mydb = pymysql.connect(host='127.0.0.1',user='root',password='1998',database="biz_card",port=3306)
...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Saravanan J ",
                   page_icon='💼',
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Saravanan J*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image("https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/gigs/292442408/original/4826ec125e65902ee6e7e1a2851f85ed6d99e8f1/convert-images-and-rewrite-their-content-into-texts-and-prepare-researches.jpg",width=500)
